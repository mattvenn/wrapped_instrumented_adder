...
test_wrapper:
	rm -rf sim_build/
	mkdir sim_build/
	iverilog -DMPRJ_IO_PADS=38 -DCOCOTB_SIM -o sim_build/sim.vvp -s wrapped_instrumented_adder_ripple -g2012 wrapper.v instrumented_adder/src/instrumented_adder.v instrumented_adder/src/ripple_carry.v
